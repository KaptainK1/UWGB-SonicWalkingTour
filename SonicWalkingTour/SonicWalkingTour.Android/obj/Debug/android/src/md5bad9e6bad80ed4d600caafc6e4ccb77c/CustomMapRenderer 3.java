package md5bad9e6bad80ed4d600caafc6e4ccb77c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CustomRenderer.Droid.CustomMapRenderer, SonicWalkingTour.Android", CustomMapRenderer.class, __md_methods);
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CustomMapRenderer, SonicWalkingTour.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CustomMapRenderer, SonicWalkingTour.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public CustomMapRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CustomRenderer.Droid.CustomMapRenderer, SonicWalkingTour.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
